...
* `manifest.json` 保存 `RunManifestV1`，包含 frozen MacroDefinition、canonical SHA-256 definition hash、MacroRecord id/revision、serverInstanceId、roomId、roomGeneration、terminalStructureRevision及 frozen index/type/terminalId/launchId bindings。
