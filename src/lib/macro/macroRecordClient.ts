...
export class MacroRecordClient {
  ...
  async create(definition: MacroDefinitionV6): Promise<MacroRecord> {
  ...
  async update(record: MacroRecord, definition: MacroDefinitionV6, lease: ContentEditLeaseGrant): Promise<{ record: MacroRecord; leaseOutcome: ContentCommitLeaseOutcome }> {
