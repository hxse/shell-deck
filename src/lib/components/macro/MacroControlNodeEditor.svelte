...
{:else if node.type === 'parallel'}
  <ParallelLaneTabs {draft} nodeId={node.id} {updateDraft} {terminalChoices} {adoptTerminalSelection} outerArtifactChoices={artifactChoices} {templateScope} {insertionPaletteMode} {telegramProfileIds} {telegramProfilesError} {currentNodeId} {depth} />
{:else}
