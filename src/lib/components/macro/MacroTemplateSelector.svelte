<script lang="ts">
  ...
  $effect(() => {
    ...
    const closeOnEscape = (event: KeyboardEvent) => {
      if (event.key === 'Escape') templatePopoverOpen = false
    }
...
<div class="macro-header">
  ...
  <div class="macro-template-picker" data-testid="macro-template-picker">
    <button
      type="button"
      class="macro-template-drawer"
      data-testid="macro-template-drawer"
      aria-expanded={templatePopoverOpen}
      aria-controls="macro-template-drawer-body"
      onclick={() => { templatePopoverOpen = !templatePopoverOpen }}
    >
    ...
    {#if templatePopoverOpen}
      <button class="popover-dismiss-layer macro-template-dismiss-layer" type="button" data-testid="macro-template-dismiss-layer" aria-label="Close macro templates" onclick={() => { templatePopoverOpen = false }}></button>
      <section
        id="macro-template-drawer-body"
        class="macro-template-drawer-body macro-template-drawer-popover"
        data-testid="macro-template-drawer-body"
