...
function parallelReviewNode(waitOnDocs = false): ParallelNode {
  ...
  const docsBody: ParallelNode["lanes"][number]["body"] = [
    { id: "send_docs", type: "send", terminal: worker, message: { parts: [{ kind: "text", text: waitOnDocs ? "docs timeout" : "docs ready" }] }, delivery: "direct", ending: "cr" },
  ...
  return {
    ...
    lanes: [
      ...
      { id: "tests", label: "Tests", terminal: reviewer, body: [
        { id: "send_tests", type: "send", terminal: reviewer, message: { parts: [{ kind: "text", text: "tests ready" }] }, delivery: "direct", ending: "cr" },
...
test("Flow V2 runner executes send, wait, capture, if.text_match and finish", async () => {
  ...
  try {
    h.templateStore.save("local", template("flow_happy", [
      { id: "send", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "hello ready" }] }, delivery: "direct", ending: "cr" },
  ...
  try {
    h.templateStore.save("local", template("finish_action_body", [
      { id: "finish_done", type: "finish", reason: "done", body: [
        { id: "send_before_finish", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "before-return-action" }] }, delivery: "direct", ending: "cr" },
      ] },
    ]), h.manager.indexMap("local"))
...
test("Flow V2 send concatenates ordered text and source parts without implicit separators", async () => {
  ...
  try {
    h.templateStore.save("local", template("send_parts_flow", [
      { id: "seed", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "seed-context" }] }, delivery: "direct", ending: "cr" },
      { id: "capture", type: "capture-source", capture: { kind: "terminal-buffer", terminal: { kind: "alias", value: "worker" }, mode: "scrollback-tail", maxChars: 12000 } },
      { id: "send_composite", type: "send", terminal: { kind: "alias", value: "reviewer" }, message: { parts: [{ kind: "text", text: "prefix[" }, { kind: "artifact", source: { kind: "step_artifact", stepId: "capture", artifact: "captured_text" } }, { kind: "text", text: "]suffix" }] }, delivery: "direct", ending: "cr" },
...
test("Flow V2 send ending cr records content and CR write payload", async () => {
  ...
  try {
    h.templateStore.save("local", template("send_ending_cr", [
      { id: "send_submit", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "submit me" }] }, delivery: "direct", ending: "cr" },
      { id: "finish_done", type: "finish", reason: "done" },
    ]), h.manager.indexMap("local"))
...
test("Flow V2 send ending none writes exact content without suffix", async () => {
  ...
  try {
    h.templateStore.save("local", template("send_ending_none", [
      { id: "send_raw", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "raw text" }] }, delivery: "direct", ending: "none" },
      { id: "finish_done", type: "finish", reason: "done" },
    ]), h.manager.indexMap("local"))
...
test("terminal-buffer raw-stream-tail uses raw artifact as captured_text", async () => {
  ...
  try {
    h.templateStore.save("local", template("raw_capture_flow", [
      { id: "seed", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "seed-raw" }] }, delivery: "direct", ending: "cr" },
...
test("Flow V2 send can append rendered text to a text box deck slot", async () => {
  ...
  try {
    h.templateStore.save("local", template("send_to_text_box", [
      { id: "send_collect", type: "send", terminal: { kind: "alias", value: "collector" }, message: { parts: [{ kind: "text", text: "collected result" }] }, delivery: "direct", ending: "cr" },
      { id: "finish_done", type: "finish", reason: "done" },
    ]), h.manager.indexMap("local"))
...
test("Flow V2 extract_text filters and selects captured text for downstream send", async () => {
  ...
  try {
    h.templateStore.save("local", template("extract_text_flow", [
      { id: "seed", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "alpha" }] }, delivery: "direct", ending: "cr" },
      { id: "capture", type: "capture-source", capture: { kind: "terminal-buffer", terminal: { kind: "alias", value: "worker" }, mode: "scrollback-tail", maxChars: 12000 } },
      ...
      { id: "send_extract", type: "send", terminal: { kind: "alias", value: "reviewer" }, message: { parts: [{ kind: "text", text: "got:" }, { kind: "artifact", source: { kind: "step_artifact", stepId: "extract_last", artifact: "extracted_text" } }] }, delivery: "direct", ending: "cr" },
      { id: "finish_done", type: "finish", reason: "done" },
    ]), h.manager.indexMap("local"))
...
test("Flow V2 input uses one defaultSource as editable runtime input", async () => {
  ...
  try {
    h.templateStore.save("local", template("input_flow", [
      { id: "seed", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "default context" }] }, delivery: "direct", ending: "cr" },
      { id: "capture", type: "capture-source", capture: { kind: "terminal-buffer", terminal: { kind: "alias", value: "worker" }, mode: "scrollback-tail", maxChars: 12000 } },
      { id: "input", type: "input", terminal: { kind: "alias", value: "worker" }, prompt: "Direction", allowEmpty: false, defaultSource: { kind: "step_artifact", stepId: "capture", artifact: "captured_text" }, delivery: "direct", ending: "cr" },
      { id: "finish_done", type: "finish", reason: "done" },
    ]), h.manager.indexMap("local"))
  ...
  try {
    ...
    h.templateStore.save("local", template("extract_continue_loop", [
      ...
      { id: "loop_count", type: "for", range: { kind: "count", count: 2 }, body: [
        ...
        { id: "send_should_skip", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "should-not-run" }] }, delivery: "direct", ending: "cr" },
      ] },
      { id: "send_after_loop", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "after-loop" }] }, delivery: "direct", ending: "cr" },
      { id: "finish_done", type: "finish", reason: "done" },
    ]), h.manager.indexMap("local"))
  ...
  try {
    h.templateStore.save("local", template("forever_break", [
      { id: "loop_forever", type: "for", range: { kind: "forever" }, body: [
        { id: "send_loop", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "text", text: "FOREVER_BREAK_READY" }] }, delivery: "direct", ending: "cr" },
...
test("Flow V2 parallel merges lane outputs for downstream send", async () => {
  ...
  try {
    h.templateStore.save("local", template("parallel_flow", [
      parallelReviewNode(),
      { id: "send_merged", type: "send", terminal: { kind: "alias", value: "worker" }, message: { parts: [{ kind: "artifact", source: { kind: "step_artifact", stepId: "parallel_review", artifact: "merged_text" } }] }, delivery: "direct", ending: "cr" },
    ]), h.manager.indexMap("local"))
