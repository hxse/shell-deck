  ...
  body: [
    {
      ...
      lanes: [
        { id: "review", label: "Review", terminal: { kind: "alias", value: "shell_1" }, body: [
          { id: "send_review", type: "send", terminal: { kind: "alias", value: "shell_1" }, message: { parts: [{ kind: "text", text: "review ready" }] }, enter: true },
        ...
        { id: "tests", label: "Tests", terminal: { kind: "alias", value: "shell_2" }, body: [
          { id: "send_tests", type: "send", terminal: { kind: "alias", value: "shell_2" }, message: { parts: [{ kind: "text", text: "tests ready" }] }, enter: true },
    ...
    { id: "send_merged", type: "send", terminal: { kind: "alias", value: "shell_1" }, message: { parts: [{ kind: "artifact", source: { kind: "step_artifact", stepId: "parallel_review", artifact: "merged_text" } }] }, enter: true },
