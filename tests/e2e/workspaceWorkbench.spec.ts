...
const template = {
  ...
  body: [
    { id: 'send', type: 'send', terminal: { kind: 'alias', value: 'shell_1' }, message: { parts: [{ kind: 'text', text: 'workbench-run' }] }, delivery: "direct", ending: "cr" },
    { id: 'input', type: 'input', terminal: { kind: 'alias', value: 'shell_1' }, prompt: 'Workbench input', allowEmpty: false, delivery: "direct", ending: "cr" },
